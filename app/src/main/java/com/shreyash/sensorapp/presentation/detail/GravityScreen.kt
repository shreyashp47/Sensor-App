...
private fun GravityContent(
    ...
    Column(
        ...
        Text(
            text = "X: ${formatDetailValue(currentReading?.values?.getOrNull(0))} ${sensorUnitText(SensorType.GRAVITY.unitX)}" +
                    "  Y: ${formatDetailValue(currentReading?.values?.getOrNull(1))} ${sensorUnitText(SensorType.GRAVITY.unitY)}" +
                    "  Z: ${formatDetailValue(currentReading?.values?.getOrNull(2))} ${sensorUnitText(SensorType.GRAVITY.unitZ)}",
